        ...
        onRequestClose={botonCerrar}>
          <View style={styles.modalContenedor}>
            <View style={styles.modalVista}>
              ...
              <TextInput style={styles.modalInput} placeholder="Escribe tu Nombre" placeholderTextColor="#888" value={descripcion} onChangeText={(texto)=>setDescripcion(texto)}/>
              <TextInput style={styles.modalInput} placeholder="Escribe tu Numero Favorito" placeholderTextColor="#888" value={numfav} onChangeText={(texto)=>setNumfav(texto)}/> 
